...
const RegisterPage = () => {
  ...
  const res =  await fetch(import.meta.env.VITE_API_URL + "/users",{
      "method" : "POST",
      "body" : JSON.stringify({"name" : data.name,"email" : data.email, "password" : data.password, "password_confirmation" : data.password_confirmation, "created_at" : new Date().toISOString()}),
      "headers" : {
